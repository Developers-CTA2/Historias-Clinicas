...
class StorePatientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'bloodType' => 'required|numeric|between:1,8',
            ...
            'scholarship' => 'required|numeric|between:1,6',
            'colony' => 'required|string|max:255', 
            'cp' => 'required|digits_between:5,5',
            'street' => 'required|string|max:255',
            'number' => 'required|numeric',
            'intNumber' => 'sometimes|required|numeric',
            ...
            'listDrugAddiction.*.input2' => 'nullable|string|max:255',
            ...
            'listPathologicalHistory.*.value' => 'nullable|required_if:listPathologicalHistory.*.type,hospitalizacion,string,max:255',
            'listPathologicalHistory.*.value' => 'nullable|required_if:listPathologicalHistory.*.type,cirugia,string,max:255',
            'listPathologicalHistory.*.value' => 'nullable|required_if:listPathologicalHistory.*.type,transfusion,string,max:255',
            'listPathologicalHistory.*.value' => 'nullable|required_if:listPathologicalHistory.*.type,traumatismo,string,max:255',
            ...
            'listGynecologyObstetrics.numGestas' => 'required_if:gender,2,numeric,between:1,50',
    ...
    public function messages() : array {
        return[
            ...
            'intNumber.numeric' => 'El campo número interior debe ser un número',
            'cp.required' => 'El campo código postal es requerido',
            'cp.digits_between' => 'El campo código postal debe tener 5 dígitos',
