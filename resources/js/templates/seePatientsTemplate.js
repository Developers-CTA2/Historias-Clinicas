...
// const iconDoctor = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
//         viewBox="0 0 24 24">
...
// const iconNutritionist = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
//                                         viewBox="0 0 24 24">
//                                         <path fill="#000000"
...
export const IconsWithLabelTemplate = (icons = '', title = '', label = '') => {
    return h('div', {
        'class': 'd-flex mb-2 align-items-center gap-2'
    }, [
        h('div', {
            'class': `rounded-icon ${icons == 'doctor' ? 'icon-blue' : 'icon-green'}`
        }, [
            icons == 'doctor' ? iconDoctor : iconNutritionist,
        ]),
    ],
        h('p', {
            class: 'mb-0'
