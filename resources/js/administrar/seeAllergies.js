                ...
                },
                {
                    ...
                    formatter: (_, row) =>
                        html(
                            ...
                            <button class="btn-sec fst-normal py-2 px-3 edit-allergy" data-id="${row.cells[0].data}" data-name="${row.cells[1].data}" data-bs-toggle="modal" data-bs-target="#Edit-allergy">
