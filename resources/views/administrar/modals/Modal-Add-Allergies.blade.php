   ...
   <div class="modal fade" id="Add-allergy" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-footer">
                   ...
                   <x-button-custom class="btn-blue-sec" text="Guardar" id="Add_allergy"  tooltipText="Guardar cambios">
                       <x-slot name="icon">
