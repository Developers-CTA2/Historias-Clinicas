{{-- Modal para agregar un nuevo tipo  de enfermedad  --}}
<div class="modal fade" id="Add-diseasse" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-blue">
                <h5 class="modal-title" id="staticBackdropLabel">Agregar un tipo de enfermedad</h5>
            ...
            <div class="modal-body">
                ...
                {{-- Alerta de edicion  --}}
                <x-alert-manage containerClass="Alerta_disease" textClass="Alerta_disease_text">
                </x-alert-manage>

                {{-- Alerta para mostrar los errores que manda el controlador --}}
                <x-alert-manage-errors contClass="Error_disease" ListClass="errorList" />
