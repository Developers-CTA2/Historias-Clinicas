       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   ...
                   {{-- Alerta de edicion  --}}
                   <x-alert-manage containerClass="Alerta_addiction" textClass="Alerta_addiction_text">
                   </x-alert-manage>

                   {{-- Alerta para mostrar los errores que manda el controlador --}}
                   <x-alert-manage-errors contClass="Error_addiction" ListClass="errorList" />
                   ...
                   <div class="row mt-0 pt-0">
                       <div class="col-12 px-3 ">
                           <div class="form-group pt-2">
                               <label for="New_nombre">Nombre de la addición <span class="red-color"> *</span></label>
               ...
               <div class="modal-footer">
                   ...
                   <x-button-custom class="btn-blue-sec"  id="Add_addiction" text="Guardar" tooltipText="Guardar cambios">
                       <x-slot name="icon">
