   ...
   <div class="modal fade" id="Edit-allergy" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body">
                   ...
                   {{-- Alerta de edicion  --}}
                   <x-alert-manage containerClass="Alerta_edit_allergy" textClass="Alerta_edit_allergy_text">
                   </x-alert-manage>

                   {{-- Alerta para mostrar los errores que manda el controlador --}}
                   <x-alert-manage-errors contClass="Error_edit_allergy" ListClass="errorList" />
                   ...
                   <div class="row mt-0 pt-0">
                       <div class="col-12 px-3 ">
                           <div class="form-group pt-2">
                               <label for="A_nombre">Nombre <span class="red-color"> *</span></label>
               ...
               <div class="modal-footer">
                   ...
                   <x-button-custom class="btn-blue-sec" text="Guardar" id="E_allergy" tooltipText="Guardar cambios">
                       <x-slot name="icon">
