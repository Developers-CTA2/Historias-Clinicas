<section id="containerPersonSelect">
    <div class="row d-flex justify-content-center align-items-start gap-3">
        <div class="col-12 col-sm-8 col-md-6 col-lg-3 col-xl-3 col-xxl-2 d-flex flex-column align-items-center bg-content-custom shadow-custom text-center py-3 card-hover"
            id="udgPerson">
            <div class="bg-avatar">
