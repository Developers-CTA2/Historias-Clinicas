...
<div class="row form-step d-none animate__animated animate__fadeInUp bg-content-custom shadow-custom p-3">
    ...
    <x-form-group class="group-gyo">
        <x-slot name="label">
            <x-label-with-tooltip labelFor="numAbortos" titleLabel="Cesareas" :required="false" />
        </x-slot>
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                <path fill="currentColor"
    ...
    <x-form-group class="group-gyo">
        <x-slot name="label">
            <x-label-with-tooltip labelFor="numAbortos" titleLabel="Gestas" :required="false" />
        </x-slot>
        <x-slot name="icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                <path fill="currentColor"
    ...
    {{-- Tiene embarazo --}}
    <div class="form-check col-12 col-lg-4 d-flex mx-3 align-items-center mb-3 group-gyo">
        <input class="form-check-input w-custom-checkbox" type="checkbox" value="" id="tieneEmbarazo">
    ...
    <div class="form-floating mt-3 group-gyo">
