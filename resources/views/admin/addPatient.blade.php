                                    ...
                                    <div class="form-group">
                                        <div class="row pt-2">
                                            ...
                                            <div class="form-group col-md-3 col-sm-8 mb-2">
                                                ...
                                                <span class="text-danger fw-normal" style=" display: none;">Número no
                                                    válido.</span>
                                            </div>
                                            <div class="form-group col-md-3 col-sm-8 mb-2">
                                    ...
                                    <div class="form-group">
                                        <div class="row pt-2">
                                            ...
                                            <div class="form-group col-md-6 col-sm-12 mb-2">
                                                ...
                                                <input class="form-control" type="text" id="nss"
                                                    name="nss">
                                    ...
                                    <div class="form-group">
                                        <div class="row pt-2">
                                            <div class="form-group col-md-6 col-sm-12 mb-2">
                                                ...
                                                <span class="text-danger fw-normal" style=" display: none;">Estado civil
                                                    no válida.</span>
                        ...
                        <div class="col-12">
                            <div class="row">
                                            ...
                                            <div class="form-group col-md-8 col-sm-12 mb-4">
                                                ...
                                                <select class="form-control" name="tipo_AHF" id="tipo_AHF">
                                                    ...
                                                    @foreach ($tipos_ahf as $tipo_ahf)
                                                        <option value="{{ $tipo_ahf->id_tipo_ahf }}">
                                                            {{ $tipo_ahf->nombre }}</option>
                                                    @endforeach
                                                </select>
                                                <span class="text-danger fw-normal" style=" display: none;">Tipo no
                                                    válido.</span>
                                                ...
                                                <div class="row pt-2">
                                                    <div class="form-group col-md-8 col-sm-12 mb-2">
                                                        ...
                                                        <span class="text-danger fw-normal"
                                                            style=" display: none;">Enfermedad no válida.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="container-fluid fixed-bottom">
                                    <div class="row mt-3 justify-content-end text-end">
                                        <div class="col-6">
                                            <button class="btn button-eliminar" id="ant-data"
                                                style="margin-block-end: 30px;"> Atras</button>
                                            <button class="btn btn-primary" id="ahf-data"
                                                style="margin-block-end: 30px;"> Siguiente</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <div class="row pt-2">
                                            <div class="form-group col-md-8 col-sm-12 mb-4">
                                                ...
                                                <span class="text-danger fw-normal" style=" display: none;">Toxicomanias
                                                    no válido.</span>
                                            </div>
                                            <h5>Alimentación</h5>
                                            <div class="form-group">
                                                <div class="row pt-2">
                                                    <div class="form-group col-md-8 col-sm-12 mb-2">
                                                        ...
                                                        <span class="text-danger fw-normal" style=" display: none;">Campo
                                                            no válido.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row pt-2">
                                            <div class="form-group col-md-6 col-sm-12 mb-2">
                                                ...
                                                <input class="form-control" type="text" id="cantidad_toxi"
                                                    name="cantidad_toxi">
                                                <span class="text-danger fw-normal" style=" display: none;">Cantidad no
                                                    válido.</span>
                            ...
                            <div class="container-fluid fixed-bottom">
                                <div class="row mt-3 justify-content-end text-end">
                                    <div class="col-6">
                                        <button class="btn button-eliminar" id="ante-data"
                                            style="margin-block-end: 30px;"> Atras</button>
                                        <button class="btn btn-primary" id="apnp-data" style="margin-block-end: 30px;">
                                            Siguiente</button>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row pt-2">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <input class="form-control" type="text" name="motivo_H"
                                                    id="motivo_H">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12 mb-2">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="respuesta_C" id="si_C" value="si">
                                                            <label class="form-check-label" for="si_C">Sí</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="respuesta_C" id="no_C" value="no">
                                    ...
                                    <div class="form-group">
                                        <div class="row pt-2">
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <input class="form-control" type="text" name="motivo_TF"
                                                    id="motivo_TF">
                                                <span class="text-danger fw-normal" style=" display: none;">Motivo no
                                                    válido.</span>
                                            ...
                                            <div class="form-group">
                                                <div class="row pt-2">
                                                    ...
                                                    <div class="form-group col-md-6 col-sm-12 mb-2">
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="respuesta_TU" id="si_TU" value="si">
                                                            <label class="form-check-label" for="si_TU">Sí</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="radio"
                                                                name="respuesta_TU" id="no_TU" value="no">
