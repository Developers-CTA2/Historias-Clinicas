                        ...
                        <div class="col-12 content-custom person-data">
                            ...
                            <div class="row mt-3 text-end justify-content-end">
                                <div class="col-12 col-lg-6 d-flex flex-column-reverse flex-lg-row gap-3 justify-content-end align-items-lg-center">
                                    ...
                                    <x-button-custom type="button" class="btn-red" id="cancel" text="Cancelar" tooltipText="Cancelar el expediente del paciente">
                                        <x-slot name="icon">
                                    ...
                                    <x-button-custom type="button" class="btn-sec" id="prevStep" text="Regresar" tooltipText="Regresar al paso anterior">
                                        <x-slot name="icon">
                                    ...
                                    <x-button-custom type="button" class="btn-blue" id="nextStep" text="Siguiente" tooltipText="Avanzar al siguiente paso">
                                        <x-slot name="icon">
                                    ...
                                    <x-button-custom type="button" class="btn-blue d-none" id="sendForm" text="Enviar" tooltipText="Guardar el expediente del paciente">
                                        <x-slot name="icon">
                                    ...
                                    {{-- <x-button-custom type="button" class="btn-sec" id="prevStep" text="Regresar" tooltipText="Regresar al paso anterior"> --}}
                                    {{-- <button type="button" class="btn btn-sec py-2" id="prevStep">Regresar</button>
