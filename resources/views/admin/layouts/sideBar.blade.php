    ...
    <div class="w-full flex-grow-1" id="sidebarContainer">
        ...
        <nav class="w-100 flex-grow-1" id="sidebarContent">
            ...
            <ul class="list-unstyled mt-3">
                ...
                <li class="ms-2 d-flex flex-column">
                    ...
                    <div class="collapse Sub_menu bg-primary-custom pt-2" id="Pacientes">
                        <ul class="list-unstyled m-0">
                            <li class="d-flex">
                                <a href="{{ route('patients.patients') }}"
                                    class="sublink-custom-nav py-1 animated-icon">
                ...
                <li class="ms-2 d-flex flex-column">
                    <a class="link-custom-nav py-1 px-2 animated-icon">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 32 32">
                                <path fill="#ffffff"
                                    d="M10 2c0 7 5.57 6.426 5.57 6.426c-.122-4.426-3.669-5.621-4.119-5.754c3.925.307 4.979 5.336 4.979 5.336c2.259-3.17 4.394-2.617 4.394-2.617c-2.76.102-3.537 3.035-3.537 3.035C21.048 9.386 22 5.422 22 5.422c-4.547-1.616-5.52 2.176-5.52 2.176C17 2 10 2 10 2m6 7c-3.464 0-6.477.983-8.807 2.697C5.965 13.75 5 16.312 5 19c0 2.688.536 5.279 1.754 7.332C9.084 28.047 12.536 29 16 29c3.464 0 6.916-.953 9.246-2.668C26.464 24.279 27 21.688 27 19c0-2.688-.965-5.25-2.193-7.303C22.477 9.973 19.464 9 16 9m0 1.3c3.004 0 5.912.678 8.1 1.804c.483 1.073.621 1.887.9 3.142a50.61 50.61 0 0 0-9-.826a50.61 50.61 0 0 0-9 .826c.279-1.244.407-2.048.9-3.142c2.188-1.126 5.096-1.803 8.1-1.803zM10.443 16a1.44 1.44 0 1 1 0 2.877a1.438 1.438 0 1 1 0-2.877m3.702.002c.805 0 1.443.636 1.443 1.441a1.43 1.43 0 0 1-1.443 1.434a1.43 1.43 0 0 1-1.434-1.434a1.43 1.43 0 0 1 1.434-1.441m3.71 0a1.43 1.43 0 0 1 1.434 1.441a1.43 1.43 0 0 1-1.434 1.434a1.431 1.431 0 0 1-1.443-1.434c0-.805.638-1.441 1.443-1.441m3.702 0a1.438 1.438 0 1 1 0 2.875a1.438 1.438 0 1 1 0-2.875m-11.114 3.572a1.44 1.44 0 1 1 0 2.877a1.438 1.438 0 1 1 0-2.877m3.702 0c.805 0 1.443.639 1.443 1.444a1.43 1.43 0 0 1-1.443 1.433a1.43 1.43 0 0 1-1.434-1.433c0-.805.639-1.444 1.434-1.444m3.71 0c.795 0 1.434.639 1.434 1.444a1.43 1.43 0 0 1-1.434 1.433a1.431 1.431 0 0 1-1.443-1.433c0-.805.638-1.444 1.443-1.444m3.702 0a1.44 1.44 0 1 1 0 2.877a1.438 1.438 0 1 1 0-2.877m-11.114 3.549a1.44 1.44 0 1 1 0 2.877a1.438 1.438 0 1 1 0-2.877m3.702 0c.805 0 1.443.638 1.443 1.443A1.43 1.43 0 0 1 14.145 26a1.43 1.43 0 0 1-1.434-1.434c0-.805.639-1.443 1.434-1.443m3.71 0c.795 0 1.434.638 1.434 1.443A1.43 1.43 0 0 1 17.855 26a1.431 1.431 0 0 1-1.443-1.434c0-.805.638-1.443 1.443-1.443m3.702 0a1.44 1.44 0 1 1 0 2.877a1.438 1.438 0 1 1 0-2.877" />
                            </svg> <span class="ms-3 text-md-custom compressed-text">Nutrición</span>
                        </div>
                    </a>
                ...
                <li class="ms-2 d-flex flex-column">
                    <a href="{{ route('showAgenda') }}"  class="link-custom-nav py-1 px-2 animated-icon">
                        <div>
