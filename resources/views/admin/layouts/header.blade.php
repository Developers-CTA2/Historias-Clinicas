    ...
    <nav class="navbar-custom" id="navBar">
        ...
        <section class="d-flex justify-content-center align-items-center gap-3">
            <div class="d-md-none" id="bt-hamburger">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="hamburger-custom-btn">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item" href="#">
                        <div >
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon-custom">
