            ...
            <div class="modal-dialog  modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <x-button-custom class="btn-red" data-bs-dismiss="modal" text="Cerrar"  tooltipText="Cancelar acción">
                            <x-slot name="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="currentColor" d="m6.4 18.308l-.708-.708l5.6-5.6l-5.6-5.6l.708-.708l5.6 5.6l5.6-5.6l.708.708l-5.6 5.6l5.6 5.6l-.708.708l-5.6-5.6z"/></svg>
                            </x-slot>
                        </x-button-custom>

                        <x-button-custom class="btn-blue-sec" data-bs-dismiss="modal" text="Guardar" id="EditUser" tooltipText="Guardar cambios">
                            <x-slot name="icon">
