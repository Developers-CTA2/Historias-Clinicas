            ...
            <div class="modal-dialog  modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <x-button-custom class="btn-red" data-bs-dismiss="modal" text="Cerrar">
                            <x-slot name="icon">
                        ...
                        <x-button-custom class="btn-blue-sec" data-bs-dismiss="modal" text="Guardar los cambios" id="EditUser">
                            <x-slot name="icon">
