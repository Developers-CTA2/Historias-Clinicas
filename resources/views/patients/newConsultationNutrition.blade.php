                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <x-card-custom>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="toma_medicamentos" id="toma_medicamentos" class="form-control" required>
                            </div>
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <x-card-custom>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.1" name="peso_actual" id="peso_actual" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label for="peso_habitual" class="pb-2">Peso habitual (kg)</label>
                                <input type="number" step="0.1" name="peso_habitual" id="peso_habitual" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label for="estatura" class="pb-2">Estatura (cm)</label>
                                <input type="number" step="0.1" name="estatura" id="estatura" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label for="circunferencia_cintura" class="pb-2">Circunferencia cintura (cm)</label>
                                <input type="number" step="0.1" name="circunferencia_cintura" id="circunferencia_cintura" class="form-control" required>
                            </div>

                            <div class="mb-3">
                                <label for="circunferencia_cadera" class="pb-2">Circunferencia cadera (cm)</label>
                                <input type="number" step="0.1" name="circunferencia_cadera" id="circunferencia_cadera" class="form-control" required>
                            </div>
                        </x-card-custom>
                    </div>
                </div>
