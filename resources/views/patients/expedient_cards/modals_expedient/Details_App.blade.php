...
@section('content')
    ...
    <div class="container">
        <button id="btn-refresh-page" class="btnRestart  p-2 tooltip-container d-none animate__animated animate__fadeInUp"
        ...
        <div class="mb-3 mx-0">
            <x-card-custom title="Edición de antecedentes personales patólogicos">
                                ...
                                <div class="col-12 mt-2">
                                    <div class="row">
                                        <div class="d-flex justify-content-center gap-3">
                                            <div class=" ">
                                                <x-button-custom data-bs-toggle="collapse" data-bs-target="#Diseases_APP"
                                                    aria-expanded="false" aria-controls="Diseases_APP" type="button"
