<x-card-custom title="Ginecología y obstetricia">
    <div class="row">
        @role('Administrador')
            @php
        ...
        <div class="col-lg-6 col-12 ps-3 mt-2">
            <div class="row ms-1">
                            ...
                            <div class="form-group col-md-6 col-sm-12 pt-2">
                                ...
                                @else
                                    <div class="mt-0 Old-Data">
                                        {{ Carbon\Carbon::parse($gyo->fecha_um)->locale('es')->isoFormat('LL') }}</div>
                                @endif
        ...
        <div class="col-lg-6 col-12 ps-3 mb-2 mt-4 mt-lg-0">
            <div class="row ms-2">
                <h5 class="aling-items-center ps-0">
                    <span class="pe-2">
                ...
                <div class="row">
                    <div class="d-flex justify-content-end gap-2">
                        <x-button-custom type="button" class="btn-red  justify-content-center justify-content-lg-start"
                            text="Cancelar" id="cancel_Gyo" tooltipText="Cancelar edición.">
                            <x-slot name="icon">
