...
<div class="col-12 row ">
    <div class="d-flex justify-content-start gap-2">
        ...
        <a href="{{route('consultation.new',[$Personal->id_persona,])}}" class="btn-sec fst-normal tooltip-container py-1">
            ...
            <span class="tooltip-text">Consulta medica.</span>
        </a>

        @endif

        @if(Auth::user()->hasRole('Prestador de nutrición'))
        <a href="" class="btn-blue-sec fst-normal tooltip-container py-1" type="button" data-bs-toggle="modal"
            ...
            <span class="tooltip-text">Consulta Nutricional.</span>
        </a>
        @endif
    </div>
</div>
